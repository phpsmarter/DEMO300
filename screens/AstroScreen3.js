  ...
  return (
    <View
      style={{
        ...
        alignItems: "center",
        justifyContent: "center",
        borderColor: "rgba(165, 115, 255, 1.000)",
    ...
    >
      ...
      <ToolIcon type="FontAwesome" rotate={-90} px={50} py={0} name="bell" />
      <ToolIcon type="Entypo" rotate={-90} px={-50} py={0} name="camera" />
    </View>
  );
};
...
const ToolIcon = props => {
  const { type, name, py, px, rotate } = { ...props };
  return (
