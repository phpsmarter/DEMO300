...
import { Left, Body, Right, Icon, Button as NativeButton } from "native-base";
...
export default class DemoScreen extends Component {
  ...
  setAlignIndex = index => {
    ...
    this.setState({ textAlign: textAligns[index].textAlign });
  };
    ...
    return (
      <>
        ...
        <Animatable.View
          ...
          style={{ backgroundColor: this.state.bgcColor, flex: 1 }}
        >
          ...
          />
          <Animatable.Text
            transition={["lineHeight", "fontSize"]}
            style={[
              {
