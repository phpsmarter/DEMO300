...
const LockImage = props => {
  ...
  const pic = props.locked
    ...
    : require("../assets/images/tesla/unlock.png");
  ...
  const transStyle = [{ translateX: posX - 15 }, { translateY: posY }];
  return locked ? (
    <Image
      source={pic}
      style={{
    ...
    <View style={{ alignItems: "center", justifyContent: "center" }}>
      <Pulse
        ...
        image={{
          source: {
            uri: "http://192.168.1.100:8080/images/tesla/unlock.png"
          },
          style: {
            width: 50,
            height: 50,
...
const LockScreen = () => (
  <React.Fragment>
    ...
    <LockImage key={1} locked={false} posY={180} posX={-100} />
    <LockImage key={2} locked={false} posY={180} posX={150} />
    <LockImage key={3} locked={true} posY={280} posX={75} />
  </React.Fragment>
);
